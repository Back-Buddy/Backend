...
namespace BackBuddy.Api.Service.V1.Device.DTOs
{
    public record ReportDto
    {
        ...
        public required ReportVisibilityType? VisibilityType { get; init; } // Only set if the report is getted by the user who created it
        public required Guid? DeviceId { get; init; } // Only set if the report is getted by the user who created it
