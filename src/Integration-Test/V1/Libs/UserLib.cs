...
namespace BackBuddy.Integration_Test.V1.Libs
{
    internal class UserLib
    {
        ...
        public async Task<(JsonArray Logs, bool HasMoreEntries)> GetFollowers(string accessToken, string userId, string expandType = "None", int page = 1, int size = 10)
        {
        ...
        public async Task<(JsonArray Logs, bool HasMoreEntries)> GetFollowing(string accessToken, string userId, string expandType = "None", int page = 1, int size = 10)
        {
